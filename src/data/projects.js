export const ProjectData = [
    {
        ...
        tags: ['REST', 'Heroku','Mongo','API'], 
        demoLink: 'https://bookworm-2022-app.herokuapp.com/', 
        githubLink: 'https://github.com/DineshK90/Project-NYBookworm', 
    ...
    },
    {
        ...
        tags: ['REST', 'Heroku','Mongo'], 
        demoLink: 'https://gamerwwh.herokuapp.com/', 
        githubLink: 'https://github.com/DineshK90/GamerWWH', 
